        ...
        return (
            <View>
                ...
                <View style={{ marginLeft: 10, marginRight: 10, marginTop: 150, alignItems: 'center' }}>
                    <Text style={{ fontSize: 18 }}>Kindly <Text style={{ textDecorationLine: 'underline', color: 'blue', fontSize: 18 }} onPress={() => this.props.navigation.navigate('LoginPage')}>login</Text> to check notifications</Text>
                </View>
            </View>
        );
    }
